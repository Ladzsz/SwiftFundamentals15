...
let UserLondon = User(userName: "Lad", email: "fish@gmail.com", age: 20)

User.currentUser = UserLondon
 ...
 */
var newuser = User(userName: "mariio", email: "mushroom@gmail.com", age: 35)
print(User.login(user: newuser))
/*:
