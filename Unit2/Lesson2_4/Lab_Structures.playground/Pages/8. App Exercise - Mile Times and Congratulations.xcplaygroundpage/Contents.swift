...
struct RunningWorkout {
    ...
    var avaeragemiletime: Double {
        distance * time / time
    }
}
var myworkout = RunningWorkout(distance: 12.23, time: 5.23, elevation: 65)

print(myworkout.avaeragemiletime)
...
var mysetp = Steps(steps: 9999, goal: 10000)
