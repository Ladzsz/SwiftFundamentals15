...
var favoritebook = book(title: "Shiloh", author: "Phyliss REnolds Naylor", pages: 144, price: 29.99)
...
var laptop1 = laptop(yearpurchased: 2021)
var laptop2 = laptop(yearpurchased: 2025)
/*:
...
struct height {
    ...
    init(Hinches: Double) {
        self.Hcenti = Hinches * 2.54
        self.Hinches = Hinches
    }
    
    init(Hcenti: Double) {
        self.Hcenti = Hcenti
        self.Hinches = Hcenti / 2.54
    }
}
...
var someonesheight = height(Hinches: 65)
...
var myheight = height(Hinches: 5.6)
print(myheight)
