...
if let jandays = months["january"] {
    print(jandays)
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
let shapesarray = ["square", "circle"]
let colorsarray = ["red", "blue"]


let letshapesandcolors: [String: [String]] = [
    "shapes": shapesarray,
    "colors": colorsarray
]
print(letshapesandcolors)
...
if let lastcolor = letshapesandcolors["colors"]{
