 ...
 */
var walking: [String] = ["walk to store", "walk to park"]
var running: [String] = ["run 5 miles", "run 20 miles"]
...
var challenges: [Array] = [walking, running]
...
if commited.isEmpty {
    print("Please commit a challenged")
} else if commited.count == 1 {
    print("tyhe challenge you have chosen is \(commited[0]) ")
} else {
