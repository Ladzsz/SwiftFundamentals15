...
let destroyer = fighter(weapon: "Destroyer", remainingFirePower: 10)
...
//it does not work because weapon comes from the fighter class and falcon is of spaceship which is above that.
