...
let preimeter = width + width + height + height
print(preimeter)
...
let doulbe10: Double = 10
let double3: Double = 3
let divisionResult = doulbe10 / double3
...
print("you can use it to determine if a number is evenb or odd because if the result is not 0 it is even.")
